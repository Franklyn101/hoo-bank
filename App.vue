...
<template>
  <div class="navbar">
        ...
        <svg width="126" height="73" viewBox="0 0 266 73" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M47.339 36.0678C47.339 34.5877 47.0475 33.122 46.481 31.7545C45.9146 30.387 45.0844 29.1445 44.0377 28.0979C42.9911 27.0513 41.7486 26.221 40.3811 25.6546C39.0136 25.0882 37.548 24.7966 36.0678 24.7966C34.5876 24.7966 33.122 25.0882 31.7545 25.6546C30.387 26.221 29.1445 27.0513 28.0979 28.0979C27.0512 29.1445 26.221 30.387 25.6546 31.7545C25.0882 33.122 24.7966 34.5877 24.7966 36.0678L36.0678 36.0678H47.339Z" fill="white"/>
        ...
        <section class="hero">
            <div class="outer">
            <div @mouseover="" @mouseleave="" class="discount">
                <img src="https://hoo-tawny.vercel.app/assets/Discount.61d9dc08.svg">
                <p><span class="white">20%</span> Discount for <span class="white">1 Month</span> Account</p>
            </div>
                <div class="gen">
                    <h1>The Next<br><span class="text"> Generation</span><br><span class="length"> Payment Method</span></h1>
                    <button><span class="text">Gets</span><img src="	https://hoo-tawny.vercel.app/assets/arrow-up.012ff21b.svg"><br><span class="text"> started</span></button>
                    <div class="robot"><img src="	https://hoo-tawny.vercel.app/assets/robot.352cd501.png"></div>
                </div>
                <p class="info">Our team of experts uses a methodology to identify<br> the credit cards most likely to fit your needs. We<br> examine annual percentage rates, annual fees.</p>
            </div>
        </section>
        <section class="section">
            <div class="grid">
            <div><p>3800+ <span class="text2">USER ACTIVE</span></p></div>
            <div><p>230+ <span class="text2">TRUSTED BY COMPANY</span></p></div>
            <div><p>$230M+ <span class="text2">TRANSACTION</span></p></div>
        </div>
        <div class="cardsection">
            <div class="csinfo">
                <h1>You do the business,<br> we’ll handle the money.</h1>
                <p>With the right credit card, you can improve your<br> financial life by building credit, earning rewards and<br> saving money. But with hundreds of credit cards on<br> the market.</p>
        ...
        <div class="cards">
                ...
                <div class="feature-card">
                    <div class="ro-img">
                    <img src="https://hoo-tawny.vercel.app/assets/Star.b8bf87ea.svg">
                    </div>
                    <div>
                    <h4>Rewards</h4>
                    <p>The best credit cards offer some tantalizing combinations<br> of promotions and prizes</p>
                    </div>
                </div> 

                <div class="feature-card">
                    <div class="ro-img">
                    <img src="https://hoo-tawny.vercel.app/assets/Shield.6d9e87e5.svg">
                    </div>
                    <div>
                    <h4>100% Secured</h4>
                    <p>We take proactive steps make sure your information and<br> transactions are secure.</p>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <div class="ro-imgg">
                    <img src="https://hoo-tawny.vercel.app/assets/Send.454b3199.svg">
                    </div>
                    <div class="pinfo">
                    <h4>Balance Transfer</h4>
                    <p>A balance transfer credit card can save you a lot of<br> money in interest charges.</p>
                    </div>
                </div>
